...
public class QRCode3 extends AsyncTask<String, Void, String> {
    ...
    public QRCode3(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                ...
                String link = "http://www.bteelse.com/blog/uqr/sip_qrcode/enviar_sip3.php";
