...
public class CreateQRCode1 extends AsyncTask<String, Void, String> {
    ...
    public CreateQRCode1(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                userID = (String) arg0[0];
                String link = "http://www.bteelse.com/blog/uqr/criar_novo_qr/novoqr_7dias.php";
