...
/**
 * Created by Felipe on 9/21/2016.
 */
...
public class QRCode2 extends AsyncTask<String, Void, String> {
    ...
    public QRCode2(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                ...
                String link = "http://www.bteelse.com/blog/uqr/sip_qrcode/enviar_sip2.php";
                String data = URLEncoder.encode("idusuario", "UTF-8") + "=" + URLEncoder.encode(userID, "UTF-8");
