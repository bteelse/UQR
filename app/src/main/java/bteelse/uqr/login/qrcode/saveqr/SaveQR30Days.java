...
/**
 * Created by Felipe on 11/15/2016.
 */

public class SaveQR30Days extends AsyncTask<String, Void, String> {
    ...
    public SaveQR30Days(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                userID = (String) arg0[0];
                String link = "http://bteelse.com/blog/uqr/salvar_qrcode/QR30dias.php";
