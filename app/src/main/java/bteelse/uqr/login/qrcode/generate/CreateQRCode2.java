 ...
 */
public class CreateQRCode2 extends AsyncTask<String, Void, String> {
    ...
    public CreateQRCode2(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                ...
                String link = "http://www.bteelse.com/blog/uqr/criar_novo_qr/novoqr_30dias.php";
