...
public class SaveQR90Days extends AsyncTask<String, Void, String> {
    ...
    public SaveQR90Days(Context context, int flag, TextView sip) {
    ...
    protected String doInBackground(String... arg0) {
        if (byGetOrPost == 0) { //means by Get Method
            ...
            try {
                userID = (String) arg0[0];
                String link = "http://bteelse.com/blog/uqr/salvar_qrcode/QR90dias.php";
